...
$query = mysql_query("SELECT * FROM stiri WHERE id = 8") or die(mysql_error());
...
echo "	<div style='text-align:center;color:#FFFFFF;width: 950px;margin: 0px auto;'>
		...
		<article>
			...
			<p style='font-size:120%;'> $text10
			</p>
			
			<p style='font-size:120%;'>$text11
			</p>
			
			<p style='font-size:120%;'>$text12
			</p>
 
 			<p  style='text-align:left;font-size:110%;'>$text13</p>
		</article>
	</div>
</div>
";
