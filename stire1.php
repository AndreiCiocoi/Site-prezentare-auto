...
<html>
<head>
<link rel="stylesheet" href="stire1.css">
</head>
<body>
<div id="stire">
<img src="imagini/stire1.jpg">
<article>
<h1>Specialistii ne invata: cum alegem anvelopele potrivite si cum<br> verificam masina la sfarsit de iarna</h1>
...
<h3 class="h4"><b>1. Alegerea corecta a anvelopelor</b></h3>
<p >Daca dupa sezonul rece trebuie sa achizitionam un set de vara nou, 
trebuie sa luam in calcul cateva aspecte. <b>In primul rand,
 ...
 <p id="border">Eticheta EU ne arata eficienta, franarea pe carosabil umed si nivelul de zgomot</p>
 <h3 class="h4"><b>2. Echilibrarea rotilor la fiecare inceput de sezon</b></h3>
 <p>Nu conteaza daca avem un set suplimentar de vara fata de cel de iarna, cu jante si 
 ...
 <h3 class="h4"><b>3. Presiunea perfecta in anvelope</b></h3>
 <p>Multi soferi din Romania omit sa verifice presiunea din anvelope si circula fara sa umble la roti
 ...
 <p id="border">Putem sa verificam presiunea si singuri, in orice benzinarie</p>
 <h3 class="h4"><b>4. Cauciucurile all-season, un compromis nedorit</b></h3>
 <p>Anvelopele dedicate folosirii anului intreg, numite mixte sau all-season, sunt bune la tot
 ...
 <h3 class="h4"><b>5. Anvelopa dedicata sezonului in care suntem</b></h3>
 <p>Producatorii de pneuri nu au facut degeaba doua tipuri, in functie de sezon, adica pneuri de vara
 ...
 <p id="border">Anvelopa de vara (stanga) vs. anvelopa de iarna (dreapta)</p>
 <h3 class="h4"><b>6. Mai putin de 1,6 mm profil ne poate costa viata</b></h3>
 <p><b>Conform legislatiei in vigoare, Registrul Auto Roman spune ca o anvelopa nu are voie sa fie 
 ...
 <h3 class="h4"><b>7. Geometria, recomandata cel putin o data pe an</b></h3>
 <p>Specialistii ne recomanda sa facem geometria rotilor cel putin o data pe an, de preferat la sfarsit 
...
<a target="_blank" href="imagini/geometrie.jpg"> <img src="imagini/geometrie.jpg"></a>
 <p id="border">O geometrie computerizata ne scapa de uzura neuniforma a pneurilor</p>
 <h3 class="h4"><b>8. Verificarea lichidelor si a bateriei auto</b></h3>
 <p>Tot un sfat la inceputul sezonului cald, ca sa evitam problemele din concediu, este sa ne uitam la 
 ...
 <h3 class="h4"><b>9. Inspectie GRATUITA a masinii la final de iarna</b></h3>
 <p>Tot din aceleasi motive ca cele enumerate mai sus, cum ar fi gropi, borduri, 
 ...
 service-uri mari care tin la siguranta soferilor, cum este si cazul <a href="http://www.toplacservice.ro/">Top Lac Auto.</a></p>
 <a target="_blank" href="imagini/toplacauto.jpg"><img src="imagini/toplacauto.jpg"></a>
 <p id="border">Echipa Top Lac Auto</p>
 <p id="sursa"><b>Sursa:www.4tuning.ro</b></p>
 </article>
</div>
</body>
</html>
