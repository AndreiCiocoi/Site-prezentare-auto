...
<div id="stire" style='text-align:center;color:#999999;width: 950px;margin: 0px auto;'>
	...
	<article>
		...
		Adica anvelope fabricate pentru o anumita viteza maxima, pentru un anumit grad de incarcatura si 
 		...
 		<a target="_blank" href="imagini/etichetaue.jpg"><img src="imagini/etichetaue.jpg"></a>
 		
 		<p id="border" style='color:white;font-size:120%;'>Eticheta EU ne arata eficienta, franarea pe carosabil umed si nivelul de zgomot</p>
 
 		<h3 class="h4" style='text-align:left;'><b>2. Echilibrarea rotilor la fiecare inceput de sezon</b></h3>
 		
 		<p style='font-size:120%;text-indent: 50px;'>Nu conteaza daca avem un set suplimentar de vara fata de cel de iarna, cu jante si 
 		...
 		jante + anvelope, ca sa ne asiguram ca nu o sa avem probleme in sezonul cald care urmeaza.</p>
 
 		<h3 class="h4"style='text-align:left;'><b>3. Presiunea perfecta in anvelope</b></h3>
 
 		<p style='font-size:120%;text-indent: 50px;'>Multi soferi din Romania omit sa verifice presiunea din anvelope si circula fara sa umble la roti
 		...
 		Asadar, nu strica sa ne uitam cel putin o data pe luna la presiunea din rotile noastre.</p>
 		
 		<a target="_blank" href="imagini/anvelope.jpg"><img src="imagini/anvelope.jpg"></a>
 
 		<p id="border"style='color:white;font-size:120%;'>Putem sa verificam presiunea si singuri, in orice benzinarie</p>
 
 		<h3 class="h4"style='text-align:left;'><b>4. Cauciucurile all-season, un compromis nedorit</b></h3>
 
 		<p style='font-size:120%;text-indent: 50px;'>Anvelopele dedicate folosirii anului intreg, numite mixte sau all-season, sunt bune la tot
 		...
 		canicula, fie ca este polei si ger.</b></p>
 
 		<h3 class="h4"style='text-align:left;'><b>5. Anvelopa dedicata sezonului in care suntem</b></h3>
 
 		<p style='font-size:120%;text-indent: 50px;'>Producatorii de pneuri nu au facut degeaba doua tipuri, in functie de sezon, adica pneuri de vara
 		...
 		acest sistem eficient poate duce la accidente grave.</b></p>
 
 		<a target="_blank" href="imagini/cauciucuri.jpg"><img src="imagini/cauciucuri.jpg"></a>
 		
 		<p id="border"style='color:white;font-size:120%;'>Anvelopa de vara (stanga) vs. anvelopa de iarna (dreapta)</p>
 		
 		<h3 class="h4"style='text-align:left;'><b>6. Mai putin de 1,6 mm profil ne poate costa viata</b></h3>
 		
 		<p style='font-size:120%;text-indent: 50px;'><b>Conform legislatiei in vigoare, Registrul Auto Roman spune ca o anvelopa nu are voie sa fie 
 		...
 		pagubit sau vinovat, riscam ca societatea de asigurari sa nu ne despagubeasca din cauza anvelopelor uzate!</b></p>
 
 		<h3 class="h4"style='text-align:left;'><b>7. Geometria, recomandata cel putin o data pe an</b></h3>
 		
 		<p style='font-size:120%;text-indent: 50px;'>Specialistii ne recomanda sa facem geometria rotilor cel putin o data pe an, de preferat la sfarsit 
 		...
 		neuniform, e bine sa facem o geometrie.</p>

		<a target="_blank" href="imagini/geometrie.jpg"> <img src="imagini/geometrie.jpg"></a>
 
 		<p id="border" style='color:white;font-size:120%;'>O geometrie computerizata ne scapa de uzura neuniforma a pneurilor</p>
 
 		<h3 class="h4"style='text-align:left;'><b>8. Verificarea lichidelor si a bateriei auto</b></h3>
 
 		<p style='font-size:120%;text-indent: 50px;'>Tot un sfat la inceputul sezonului cald, ca sa evitam problemele din concediu, este sa ne uitam la 
 		...
 		<a target="_blank" href="imagini/lichide.jpg"><img src="imagini/lichide.jpg"></a>
 		
 		<h3 class="h4"style='text-align:left;'><b>9. Inspectie GRATUITA a masinii la final de iarna</b></h3>
 
 		<p style='font-size:120%;text-indent: 50px;'>Tot din aceleasi motive ca cele enumerate mai sus, cum ar fi gropi, borduri, 
 		...
 		service-uri mari care tin la siguranta soferilor, cum este si cazul <a href="http://www.toplacservice.ro/" style='text-decoration: none;color:white;'>Top Lac Auto.</a></p>
 
 		<a target="_blank" href="imagini/toplacauto.jpg"><img src="imagini/toplacauto.jpg"></a>
 
 		<p id="border" style='color:white;font-size:120%;'>Echipa Top Lac Auto</p>
